...
CREATE TABLE `telephones` (
  ...
  UNIQUE KEY `mainNumber` (`mainNumber`),
  KEY `idCustomer` (`idCustomer`),
  KEY `idSupplier` (`idSupplier`),
  CONSTRAINT `telephones_ibfk_1` FOREIGN KEY (`idCustomer`) REFERENCES `customers` (`id`),
  CONSTRAINT `telephones_ibfk_2` FOREIGN KEY (`idSupplier`) REFERENCES `suppliers` (`id`)
