...
CREATE TABLE `categories_product` (
  ...
  CONSTRAINT `categories_product_ibfk_1` FOREIGN KEY (`idCategory`) REFERENCES `categories` (`id`),
  CONSTRAINT `categories_product_ibfk_2` FOREIGN KEY (`idProduct`) REFERENCES `products` (`id`)
